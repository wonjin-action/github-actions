...
import { LambdaFrontConstruct } from '..';
import { PipelineEcspressoConstruct } from '../../pipeline-ecspresso-construct';

export interface LambdaPipelineConstructProps extends cdk.StackProps {
  prefix: string;
...
export class PipelineLambdaConstruct extends Construct {
